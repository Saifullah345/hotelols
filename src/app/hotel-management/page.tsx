...
const TESTIMONIALS = [
  { name: 'Asad Malik', hotel: 'Pearl Continental, Lahore', rating: 5, text: 'Switched from paper registers to BookQayam in one day. Booking management is now ten times faster and guests love the receipts.' },
      ...
      <section className="bg-gray-50 border-y border-gray-100 py-20 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500">Real feedback from properties using BookQayam every day.</p>
          </div>

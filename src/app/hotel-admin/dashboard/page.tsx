...
import { BedDouble, CalendarCheck, DollarSign, Clock, TrendingUp, Building2, Sparkles } from 'lucide-react'
...
export default async function HotelAdminDashboard() {
  ...
  const stats = [
    ...
    { title: 'Available Rooms', value: availableRooms ?? 0, icon: BedDouble, iconBg: 'bg-emerald-50', iconColor: 'text-emerald-600', href: '/hotel-admin/rooms?status=available' },
    { title: 'Total Bookings', value: totalBookings ?? 0, icon: CalendarCheck, iconBg: 'bg-indigo-50', iconColor: 'text-indigo-600', change: 15, href: '/hotel-admin/bookings' },
    { title: 'Total Revenue', value: formatCurrency(totalRevenue, currency), icon: DollarSign, iconBg: 'bg-violet-50', iconColor: 'text-violet-600', change: 8, href: '/hotel-admin/reports' },
  ]

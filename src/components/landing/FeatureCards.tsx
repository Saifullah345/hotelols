...
const features = [
  { icon: Building2,  title: 'Room Management',    desc: 'Live room status, housekeeping queuesand maintenance requests — all from one screen.',                         ring: 'bg-blue-500/10 text-blue-400'     },
  { icon: Users,      title: 'Staff & Roles',       desc: 'Role-based access for admins, front deskand housekeeping. Everyone sees only what they need.',                 ring: 'bg-violet-500/10 text-violet-400' },
  ...
  { icon: BarChart3,  title: 'Revenue Analytics',   desc: 'ADR, RevPARand occupancy trends. Spot problems and opportunities before they hit the bottom line.',            ring: 'bg-amber-500/10 text-amber-400'   },
  ...
  { icon: Zap,        title: 'Real-Time Updates',   desc: 'New bookings, check-insand task assignments appear instantly across every device on your team.',               ring: 'bg-cyan-500/10 text-cyan-400'     },
]
